...
module.exports = {
  siteMetadata: {
    title: `Webadalona`,
    description: `Tu agencia de páginas web y tiendas online en Badalona (Barcelona). Posicionamiento SEO y SEM. Alto rendimiento para diferentes tamaños de negocio.`,
    author: `@webadalona`,
