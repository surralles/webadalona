...
const EditAddressForm = ({ address }) => {
    ...
    return (
        <>
            <button className={buttonForm} onClick={() => setEditAdressForm(!editAdressForm)}>Edita</button>
            {
                editAdressForm && (
                                            ...
                                            {( customerDefaultAddressUpdate ) => {
                                                return (
                                                    <form>
                                                        ...
                                                        <div>
                                                            <button className={updateForm} onClick={() => setEditAdressForm(!editAdressForm)}>Cancelar</button>
                                                        </div>
                                                    </form>
